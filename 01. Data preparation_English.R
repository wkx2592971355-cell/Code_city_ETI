...
################################################
# A Energy system structure (missing values set to NA)
################################################
...
###### The original data are rounded to units of 10,000; multiply by 10,000 for consistency.
